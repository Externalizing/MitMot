\newpage
\section{Handlungsanweisungen} % (fold)
...
\subsection{Mitarbeiter als Individuum} % (fold)
...
Jeder Mitarbeiter ist in erster Linie ein Mensch, der mit Emotionen und Gefühlen, sowie Bedürfnissen ausgestattet ist. Nach [Seelbach, 18] stimuliert den Menschen nichts mehr als der Wunsch wahrgenommen zu werden, das umfasst die Aussicht auf soziale und zwischenmenschliche Anerkennung, Wertschätzung und Zuwendung. 
...
Der Mensch ist keine Maschine. Diese Aussage ist seit Anfang des 20. Jahrhunderts und spätestens durch Charlie Chaplins Film \glqq Moderne Zeiten\grqq [Chaplin] einer breiten Masse bekannt. 
...
Müssen unbeliebte Tätigkeiten erledigt werden, kann mit in Aussichtstellung einer besonders spannenden Tätigkeit motiviert werden. 

\subsection{Belohnung}
...
Davon abgesehen können über das Cafeteria-Modell nur monetär abbildbare Werte angeboten werden. [Nowka, S. 55-57]
